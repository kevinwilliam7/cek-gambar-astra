                        ...
                        <div class="min-w-full inline-block align-middle">
                            ...
                            <table id="table1"
                                ...
                                <thead id="thead1" class="bg-gray-50 dark:bg-neutral-700/50">
                                    @php($table1_headers = ['Type Motor', 'Kode Nosin', 'Foto', 'Action'])
                                    <tr>
...
@section('js')
    <script>
        ...
        function loadTable1(currentPageTable1) {
            fetch("{{ route('datatable.motor') }}?"+ new URLSearchParams({
                ...
                .then(res => {
                    ...
                    if (res.data.length === 0) {
                        ...
                        res.data.forEach(item => {
                            if (!grouped[item.type_motor]) {
                                grouped[item.type_motor] = [];
                            }
                            grouped[item.type_motor].push(item);
                        });
                        ...
                        Object.keys(grouped).forEach(type => {
                            ...
                            items.forEach((item, index) => {
                                ...
                                // hanya render type_motor sekali dengan rowspan
                                if (index === 0) {
                                    row += `
                                        <td class="size-px whitespace-nowrap" rowspan="${rowspan}">
                                ...
                                row += `
                                    <td class="size-px whitespace-nowrap">
                                        <div class="py-3 px-5">
                                            <span class="text-sm text-gray-800 dark:text-white font-bold">
                                                ${item.kode_nosin}
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="size-px whitespace-nowrap text-right">
                                        <div class="flex gap-x-2 justify-end px-5">
                                            ...
                                            <button id="btnDelete${item.kode_nosin}" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-danger-alert" data-hs-overlay="#hs-danger-alert" type="button" class="size-8.5 inline-flex justify-center items-center gap-x-2 rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-50 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700">
