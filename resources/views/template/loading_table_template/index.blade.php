<template id="loading-table-template">
    <div class="animate-slide-down p-5 min-h-100 flex flex-col justify-center items-center text-center">
        <svg class="w-48 mx-auto mb-4 text-white" width="178" height="90" viewBox="0 0 178 90" fill="none"
            ...
            <g filter="url(#filter1)">
                ...
                <rect x="12.5" y="6.5" width="153" height="39" rx="7.5" stroke="currentColor"
                    class="stroke-gray-100 dark:stroke-neutral-700/60" shape-rendering="crispEdges"></rect>
        ...
        <div class="max-w-sm mx-auto">
            ...
            <p class="mb-5 text-sm text-gray-500 dark:text-neutral-500">
                Fetching data from server may take a few seconds.
            </p>
        </div>
    </div>
</template>
