            ...
            <div id="hs-pro-dmh"
                ...
                <div
                    ...
                    <div
                        ...
                        <a class="py-1.5 px-2 inline-flex items-center gap-x-2 font-medium text-sm whitespace-nowrap rounded-md border border-transparent text-white hover:text-white/80 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-white/10 {{ request()->routeIs('cek-kpb.index')
                            ? 'bg-white/10'
                            : '' }}"
                            href="{{ route('cek-kpb.index') }}">
                            Cek KPB
                        </a>
                        <a class="py-1.5 px-2 inline-flex items-center gap-x-2 font-medium text-sm whitespace-nowrap rounded-md border border-transparent text-white hover:text-white/80 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-white/10 {{ request()->routeIs('cek-kpb-digital.index')
                            ? 'bg-white/10'
                            : '' }}"
