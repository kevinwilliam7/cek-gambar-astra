<div id="hs-danger-alert" class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto pointer-events-none" aria-labelledby="hs-danger-alert-label" role="dialog" tabindex="-1" aria-labelledby="hs-danger-alert-label">
    <div
        ...
        <div
            ...
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-danger-alert" aria-expanded="true">
                ...
                <div class="flex gap-x-4 md:gap-x-7">
                    ...
                    <div class="grow">
                        ...
                        <p class="text-gray-500 dark:text-neutral-500">
                            Permanently remove your Data and all of its contents from database
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-hs-overlay="#hs-danger-alert" aria-expanded="true">
                    Cancel
                </button>
