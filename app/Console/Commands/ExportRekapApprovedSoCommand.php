...
class ExportRekapApprovedSoCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'export:rekap-approved-so-command {month} {year}';
    ...
    public function handle()
    {
        ...
        // Simpan file
        $exportPath = storage_path("exports/rekap_approved_so_{$month_file}_{$year_file}.xlsx");
